"""
# mlflow 실행 명령 : mlflow server --host 0.0.0.0 --port 5000 
# ㄴ 추가 옵션 : --backend-store-uri sqlite:///mlflow.db --default-artifact-root ./mlruns
# ㄴ 127.0.0.1:5000 접속해서 UI 확인 가능
"""
# retrain.py 상단에 3줄만 추가
import mlflow

# Model Version 관리 최고..... !!!!!!!!!!!!!!
# mudule 확장 : https://mlflow.org/docs/latest/api_reference/python_api/index.html
...
TRAIN_DATA = os.path.join(DATA_DIR, "loan_data.csv")
